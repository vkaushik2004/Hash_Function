...
Your name(s): Vedant Kaushik
Your team alias: むぎわら
*/
...
HashTable hash_function(k);

for (int i = 0; i<n; ++i){
    hash_function.insert(texts[i]);
}
    cout << "==== Printing the contents of the first 5 slots ====" << endl;
hash_function.printTable();
  
    cout << "==== Printing the slot lengths ====" << endl;
 for (int i = 0; i < k; ++i) {
        cout << "Slot " << i << " length: " << hash_function.getSlotLength(i) << endl;
    }
  
    cout << "==== Printing the standard variance =====" << endl;
cout << "Standard Variance: " << hash_function.getVariance() << endl;
    return 0;
}